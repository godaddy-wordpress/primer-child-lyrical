...
<body <?php body_class() ?>>
	...
	<div id="page" class="hfeed site">
		...
		<header id="masthead" class="site-header" role="banner"<?php if( ! empty( lyrical_get_header_image() ) ): ?> style="background:url('<?php echo lyrical_get_header_image( ); ?>') no-repeat top center; background-size: cover;"<?php endif; ?>>
